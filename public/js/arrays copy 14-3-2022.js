const delivery_time = {
     'MSKtoBL':{from: 16, to:21},
     'SPBtoBL':{from: 17, to:22},
     'MSKtoVL': {from: 14, to:19},
     'SPBtoVL': {from: 15, to:20},
     'MSKtoVR':{from: 2, to:3},
     'SPBtoVR':{from: 3, to:4},
     'MSKtoEK':{from: 3, to:4},
     'SPBtoEK':{from: 4, to:5},
     'MSKtoIR':{from: 9, to:10},
     'SPBtoIR':{from: 10, to:11},
     'MSKtoKZ':{from: 3, to:4},
     'SPBtoKZ':{from: 4, to:5},
     'MSKtoKD':{from: 3, to:4},
     'SPBtoKD':{from: 4, to:5},
     'MSKtoKRSN':{from: 7, to:8},
     'SPBtoKRSN':{from: 8, to:9},
     'MSKtoNN':{from: 1, to:2},
     'SPBtoNN':{from: 2, to:3},
     'MSKtoNS':{from: 6, to:7},
     'SPBtoNS':{from: 7, to:8},
     ...
     'MSKtoPM':{from: 4, to:5},
     'SPBtoPM':{from: 5, to:6},
     'MSKtoRND':{from: 3, to:4},
     'SPBtoRND':{from: 4, to:5},
     'MSKtoSM':{from: 2, to:3},
     'SPBtoSM':{from: 3, to:4},
     'MSKtoTL':{from: 2, to:3},
     'SPBtoTL':{from: 3, to:4},
     'MSKtoUU':{from: 10, to:12},
     'SPBtoUU':{from: 11, to:13},
     'MSKtoUFA':{from: 4, to:5},
     'SPBtoUFA':{from: 5, to:6},
     'MSKtoHB':{from: 14, to:19},
     'SPBtoHB':{from: 15, to:20},
     'MSKtoCLB': {from: 4, to:5},
     'SPBtoCLB':{from: 5, to:6},
     'MSKtoCT':{from: 9, to:11},
     'SPBtoCT':{from: 10, to:12},
}
