        ...
        <table class="nob">
            <tr class="nob">
                ...
                <td class="nob" style="width: 240px">
                    <div class="borbtm top-user-info rel">ООО «ВЕРНЕР ЛОГИСТИКА»<div class="abs1">(2)</div></div>
                </td>
            ...
            <tr class="nob">
                ...
                <td class="nob" rowspan="2">
                    <div class="borbtm top-user-info rel">194214, г. Санкт-Петербург, просп. Энгельса, 93/258<div class="abs1">(2a)</div></div>
                </td>
                <td class="spacer  nob"></td>
            ...
            <tr class="nob">
                ...
                <td class="nob">
                    <div class="borbtm top-user-info rel">7802895380 / 780201001<div class="abs1">(2б)</div></div>
                </td>
                <td class="spacer nob"></td>
            ...
            <tr class="nob">
                ...
                <td class="nob">
                    <div class="borbtm top-user-info rel">Счёт No T10-TH12-1 от {{ stringDateRu($order->time_to_order) }}<div class="abs1">(5)</div></div>
                </td>
                <td class="spacer nob"></td>
                <td class="nob">
            ...
            <tr class="nob">
                ...
                <td class="nob">
                    <div class="borbtm top-user-info rel">No п/п 1-4 T10-TH12-1 от {{ stringDateRu($order->time_to_order) }}<div class="abs1">(5a)</div></div>
                </td>
                <td class="spacer nob"></td>
                <td class="nob"></td>
                <td class="nob"></td>
        ...
        <table class="nob">
            <tr  class="nob">
                ...
                <td class="nob" style="width: 100px">
                    <div class="borbtm under-table-input tc rel"><br> <div class="under">(подпись)</div><img class="sign" src="./images/sign.png" alt=""></div>
                </td>
                <td class="nob" style="width: 100px">
                    <div class="borbtm under-table-input tc rel">Бунчук С. В. <div class="under">(ф.и.о)</div></div>
                </td>
                ...
                <td  style="padding-right: 20px; border-style: none; border-right: solid; ">
                    <table class="nob">
                        ...
                        <tr class="nob footer-inp-row">
                            <td class="nob footer-inp-cell" colspan="3">
                                <div class="borbtm under-table-input tc rel">
                                    ООО «ВЕРНЕР ЛОГИСТИКА», ИНН 7802895380, КПП 780201001
